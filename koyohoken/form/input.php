...
1．委託する業務の範囲は、別表１のとおりです。
2．本契約の業務委託報酬額は別表１によります。
3．別表１の業務委託報酬額表に定める手続き報酬額の支払いを受託者が確認後、手続きが開始されることを確認しました。
4.　本誓約書の有効期間は、本日より【60日】です。委託者の都合により有効期間を超える場合は、新たに本誓約書を締結する必要があります。
...
7．別表1に含まれない業務の報酬額は、その都度協議して定めます。
8．支払いされた手続き費用は、いかなる理由があっても返金されないことを理解しました。 
9．私は、反社会的勢力(暴力団、暴力団員、暴力団員でなくなった時から5年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋等、社会運動等標ぼうゴロ又は特殊知能暴力集団、その他これらに準ずる者をいう)に属する者ではなく、貴事務所との契約において暴力的な要求行為等を行いません。
