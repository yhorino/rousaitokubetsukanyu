...
<?php include_once  $_SERVER['DOCUMENT_ROOT'].'/template_php/gtag_head.html'; ?>
  ...
  <link rel="canonical" href="https://www.xn--y5q0r2lqcz91qdrc.com/koyohoken/form/done.php">
  ...
  <meta property="og:url" content="https://www.xn--y5q0r2lqcz91qdrc.com/koyohoken/form/done.php">
...
<?php include_once $_SERVER["DOCUMENT_ROOT"].'/pg_setting.php'; ?>
  <?php 
  $payment_detail = '労働保険事務組合雇用保険';
  $payment_detail_kana = 'ﾛｳﾄﾞｳﾎｹﾝｼﾞﾑｸﾐｱｲｺﾖｳﾎｹﾝ';
  $return_url = 'https://'.$_SERVER['HTTP_HOST'].'/koyohoken/form/paid.php';
  $stop_return_url = 'https://'.$_SERVER['HTTP_HOST'].'/koyohoken/form/done.php';
