...
<?php
 ...
 $name_len = mb_strlen($kanyusya['Name']);
 $name_style = '';
 if($name_len >20){
  $name_style = ' style="font-size:8px; padding-top:0.3em;" ';
 } else if($name_len >18){
  $name_style = ' style="font-size:11px; padding-top:0.2em;" ';
 } else if($name_len >16){
  $name_style = ' style="font-size:12px; padding-top:0.1em;" ';
 }
?>
...
<figure>
 ...
 <div id="kaiinsyo_div">
  ...
  <p id="name"><span id="title_name" class="kaiinsyo_title"><span>氏</span><span>名</span></span><span <?php echo $name_style;?>><?php echo $kanyusya['Name'];?></span></p>
