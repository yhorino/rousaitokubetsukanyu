...
15．短期加入からの延長は、年度末まで延長できるものとし再度短期加入を選択することはできない。延長意思確認は、当団体よりメールにて行う。一般会員は、保険期間満了月の指定期日までに延長意思確認かつ保険料等の納付（以下「延長手続き」という。）を完了しなければならない。指定期日迄に延長手続きが確認できないときは、保険期間満了日をもって脱退する意思表示とみなし保険期間満了日をもって脱退とする。
16．短期加入の一般会員が、保険期間満了月の翌月以降に長期加入で再加入を希望するときは、当団体が指定した日が加入日となる。
17.	当団体は、会員等が当団体の定める「反社会的勢力の排除条項」に該当することを知ったときは、事前に会員等に何ら通告せず本委託を解除し、かつ捜査機関への通報及び協力をしなければならない。
18.	当団体が前項の規定により事務委託を解除した場合は、会員等に損害が生じても当団体は何らこれを賠償、補償することを要しない。また、解除により当団体に損害が生じたときは、会員等はその損害を賠償しなければならない。
19.	年度更新の意思確認は、毎年11月以降に当団体より一般会員宛に郵送、ＦＡＸまたはメールにて行う。一般会員は、指定期日迄に当団体の定める方法による意思確認かつ保険料等の納付（以下「継続手続き」という。）を完了しなければならない。指定期日迄に継続手続きが確認できないときは、年度末に脱退する意思表示とみなし年度末をもって脱退とする。
20.	加入時に選択した給付基礎日額は、翌々年度に変更することができる。その後の給付基礎日額は、一般会員より特段の申し出がない限り、継続するものとする。
21. 一般会員が脱退を希望するときは、脱退届、一括有期事業報告書および会員カードの返送確認をした日の属する月の翌々月の末日をもって脱退とする。会員カードの所有権は当団体に帰属し、年度途中で脱退を希望するときは、脱退届と併せて当団体に返却しなければならない。なお、期限内に脱退届および一括有期事業報告書の提出、会員カードの返却をしない場合は、元請工事なしとの意思表示とみなし直ちに委託解除されるものとする。　
22.	一般会員が脱退を希望するときは、必ず事前に当団体に連絡しなければならない。事前の連絡がない場合は、脱退月までの保険料等が発生し一般会員は支払う義務を負うものとする。
23.	当団体は、過去に5.に該当し委託解除した一般会員の個人事業主又はその3親等以内の親族並びに法人の役員が加入希望者であったときは、原則として事務委託はできないものとする。
24．当団体は、一般会員が23．であることが判明したときは、5.に該当する者と判断し当団体が決定した日をもって脱退しなければならない。
...
<p style='text-align: right;'>作成及び使用開始；20230530</p>
              </div>
            </div>
          </section>
...
６．私（当社）が前号に違反したときは、貴団体の指定する期日または当該年度末をもって自ら脱退いたします。
７．私（当社）は過去に貴団体の指示に従わなかったこと等を事由として委託解除されたことがある場合は、再度事務委託はできないことを理解しました。
８．私（当社）は、委託解除について、脱退届、一括有期事業報告書および会員カードの返送確認をした日の属する月の翌々月の末日で脱退となることを確認しました。なお、期限内に脱退届および一括有期事業報告書の提出、会員カードの返却をしない場合は、元請工事なしとの意思表示とみなされ直ちに委託解除されることを承認します。
９．一括有期事業（末尾５）以外の保険関係を他の労働保険事務組合に委託いたしません。
10．入会前の未加入労働災害、通勤災害はありません。
11．私（当社）の第１種特別加入する者は、貴団体に申し出た通りです。
12． ２．で委託した手続は、届出書類の提出及び保険料等の納入を貴団体が確認後、開始されることを理解しました。
13．会費は、第一種特別加入者数に基づき、毎年度新たに算定されることを理解しました。
14．次年度以降の労働保険料等は、貴団体の指定した時期に、年一括で振込または私（当社）が指定した金融機関口座より口座振替にて支払います。 
15．貴団体が指定する期限までに13.の労働保険料の支払いが確認できなかったときは、私（当社）からの委託解除の意思表示とみなされ直ちに委託解除されることを承認します。
16. 15．の委託解除日を以て一括有期事業は事業廃止（労働者なし）されることを理解しました。
17. 貴団体との連絡が連続又は断続して１４日以上とれなくなったときは、理由の如何にかかわらず事業を継続する意志がないものとみなされ一方的に委託解除されても一切異議を申し立てません。
18．委託解除されたことにより被った損失に関しては、すべて自己責任であることを理解しました。
19．未納分の保険料等については、口座振替、差押え、取引先への請求、破産等の申立て等されても一切異議を申し立てません。
20．私（当社の役員、主たる株主）は、反社会的勢力（暴力団、暴力団員、暴力団員でなくなった時から５年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋等、社会運動等標ぼうゴロ又は特殊知能暴力集団、その他これらに準ずる者をいう。）に属する者ではなく、貴団体との契約において暴力的な要求行為等を行いません。
