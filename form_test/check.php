...
9.	当団体から加入希望者に対してメール等で行う手続き開始連絡前に加入希望者から加入手続き取消しの申し出があったときは、①加入希望者がすでに保険料等振込み完了済みの場合は保険料等から振込手数料を控除した額を加入希望者の指定する金融機関口座に返金するものとし、②クレジットカードで支払いの場合は当団体がクレジットカード支払いを取り消すものとする。ただし、当団体から加入希望者に対してメール等で手続き開始連絡後に当該申し出があったときは、8.に該当し加入月の末日までを保険期間とし、28．を適用する。
...
13．保険期間は、1．に定める補償開始日より一般会員からの脱退の申し出または、保険料等の口座振替不能確認後に当団体が定める脱退日、3か月加入の場合は加入日の属する月から起算して3か月後の末日または当該年度末とする。
...
22. 一般会員が脱退を希望するときは、脱退届、一括有期事業報告書および会員カードの返送確認をした日の属する月の翌々月の末日をもって脱退とする。会員カードの所有権は当団体に帰属し、年度途中で脱退を希望するときは、脱退届と併せて当団体に返却しなければならない。なお、期限内に脱退届および一括有期事業報告書の提出、会員カードの返却をしない場合は、元請工事なしとの意思表示とみなし直ちに委託解除されるものとする。　
23.	一般会員が脱退を希望するときは、必ず事前に当団体に連絡しなければならない。事前の連絡がない場合は、脱退月までの保険料等が発生し一般会員は支払う義務を負うものとする。
24.	当団体は、過去に5.に該当し委託解除した一般会員の個人事業主又はその3親等以内の親族並びに法人の役員が加入希望者であったときは、原則として事務委託はできないものとする。
25．当団体は、一般会員が24．であることが判明したときは、5.に該当する者と判断し当団体が決定した日をもって脱退しなければならない。
26.	一般会員が次のいずれかに該当する場合は、一般会員の事前合意なしに当団体の一方的判断によって脱退手続を行う。
...
⑤　その他前各号に準ずるとき
27.	一般会員は、次のいずれかに該当した場合は直ちに当団体まで連絡しなければならない。連絡がない場合は、労災保険給付請求ができない等の不利益を被ることがある。
...
⑤　その他前各号に準ずるとき 
28.	一般会員が年度途中に脱退、5.又は9.但し書きに該当し脱退となったときは、既納の保険料等のうち未使用の労働保険料から手続き費用及び振込手数料を差し引いた後に残余の労働保険料がある場合は、一般会員の指定する金融機関口座に返金する。未使用の労働保険料が、手続き費用及び振込手数料を下回る場合は返金できないものとする。
29. 第1種特別加入を脱退し、当該年度に再度第1種特別加入するときは、原則として従前の給付基礎日額で加入しなければならない　　
30.	労働保険事務組合は、法により一般会員及び一般会員に属する従業員の労災事故に係る労災保険給付請求手続は行うことができない。
31.	当団体の会費は、国税庁通達№6467に該当し仕入税額控除の対象とはならず、また、印紙税法別表第一　課税物件表第17号文書非課税物件欄2かっこ書に該当するため、印紙税法非課税である。 ただし、会員カード発行費を除く。　
32.	当団体が実施するキャンペーン、サービス等は、会員等への事前の承諾なく終了することがある。
33.	団体則、すべての規程及び規則等（以下「団体則等」という。）は、理事会または役員会に諮り会員等の事前承諾なく変更する場合がある。
34.	会員等は、上記団体則等を遵守し、団体則等の執行により被った損害等に関し如何なる名目においても当団体に損害等を請求できない。当団体は、上記団体則等の執行により会員等に生じる如何なる損害等に関しても一切責任を負わないものとする。
35.	当団体の運営並びに総会及び諸会議における議決事項については、理事長またはその会議の長に委任するものとする。
</pre>
<p style='text-align: right;'>作成及び使用開始；20230721</p>
              </div>
            </div>
          </section>
